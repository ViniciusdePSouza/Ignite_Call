...
INSERT INTO "new_user_time_intervals" ("end_time_in_minutes", "id", "time_start_in_minutes", "user_id", "week_day") SELECT "end_time_in_minutes", "id", "time_start_in_minutes", "user_id", "week_day" FROM "user_time_intervals";
